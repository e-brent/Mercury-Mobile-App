...
const lensData = [
    ...
    {id:'2', name:'SA 47mm f/5.6', base:['none', 'none', 'none', 'none'], spacer:['none', 'S1', 'S2', 'S3'], bolts:['Light Blue (10)', 'Light Blue (10)', 'Light Blue (10)', 'Light Blue (10)'], subj_dist:['INF', 25, 12, 6.5], f_22:['7 - INF', '5.75 - INF', '4.5 - INF', '3.5 - 46'], f_16:['10 - INF', '6.5 - INF', '5.5 - INF', '4 - 12'], f_8:['20 -  INF', '12 - INF', '7.5 - 30', '5 - 9']},
    ...
    {id:'5', name:'Grandagon 58mm f/5.6', base:['BASE 14', 'BASE 15', 'BASE 16'], spacer:['none', 'none', 'none'], bolts:['Light Green (25)', 'Light Green (25)', 'Light Green (25)'],subj_dist:[35, 15, 7], f_22:['8.5 - INF', '6.5 - INF', '4.5 - 19'], f_16:['10.75 - INF', '7.5 - 400', '5 - 12.5'], f_8:['16.5 - INF', '10 - 29', '5.75 - 9']},
    ...
    {/*Dropdown menu for selecting which base is being used*/}
     ...
     {/*Button displayed when on the hyperfocal tab, when pressed it executes the calculateHyperfocal() function and displays the results*/}
      ...
      {/*Results for both DOF and Hyperfocal -- will be displayed when their respective tab has been selected and their respective showResults variable has been set to true.*/}
          ...
          {selectedIndex==0 && showHyperfocalResult && (<Text style={dofStyle.textResult} accessible={true} accessibilityLabel="Base result" accessibilityRole="text">Base:  {hyperfocalBase}</Text>)}
          {selectedIndex==0 && showHyperfocalResult && (<Text style={dofStyle.textResult} accessible={true} accessibilityLabel="Spacer result" accessibilityRole="text">Spacer:  {hyperfocalSpacer}</Text>)}
